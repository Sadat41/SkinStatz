...
export class MarketHeatmap {
    ...
    generateTopSkinsData() {
        return [
            { name: 'AK Redline', count: 12, avgChange: 4.2, value: 450000, category: 'rifles' },
            { name: 'AWP Dragon', count: 3, avgChange: 12.8, value: 2100000, category: 'rifles' },
            { name: 'Karambit Fade', count: 1, avgChange: 15.3, value: 890000, category: 'knives' },
            { name: 'M4A4 Howl', count: 2, avgChange: 8.7, value: 1200000, category: 'rifles' },
            { name: 'Glock Fade', count: 8, avgChange: 3.1, value: 280000, category: 'pistols' }
        ]
    }
