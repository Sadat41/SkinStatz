...
export class DashboardPage {
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="black-card rounded-2xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button onclick="window.location.hash = '#/trading'" class="group relative bg-gray-900 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-600 text-gray-300 hover:text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center gap-2 overflow-hidden border border-gray-700 hover:border-transparent">
                ...
                <div class="black-card rounded-2xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button onclick="window.location.hash = '#/investments'" class="group relative bg-gray-900 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-600 text-gray-300 hover:text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center gap-2 overflow-hidden border border-gray-700 hover:border-transparent">
                            <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 p-0.5">
                                <div class="w-full h-full bg-gray-900 rounded-xl group-hover:bg-transparent transition-colors duration-300"></div>
                            </div>
                            <i data-lucide="plus" class="w-4 h-4 relative z-10"></i>
                ...
                <div class="black-card rounded-2xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button onclick="window.location.hash = '#/cases'" class="group relative bg-gray-900 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-600 text-gray-300 hover:text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center gap-2 overflow-hidden border border-gray-700 hover:border-transparent">
    ...
    initializeFallbackPerformanceChart(data) {
        ...
        const performanceChartEl = document.getElementById('performance-trend-chart')
        if (!performanceChartEl) {
            console.warn('⚠️ Performance chart element not found')
            return
        }
        
        const fallbackChart = performanceChartEl.querySelector('.fallback-chart')
        if (!fallbackChart) {
            console.warn('⚠️ Fallback chart not found')
            return
        }
        if (data.length === 0) {
