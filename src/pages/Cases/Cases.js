...
export class CasesPage {
            ...
            <div class="bg-gray-900 border border-gray-700 rounded-xl p-6 mb-6 hidden" id="week-summary-container">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div class="bg-gray-900 border border-gray-700 rounded-xl p-4 text-center">
                        ...
                        <div class="text-2xl font-bold text-white mb-1" id="week-total-cases">1</div>
                    ...
                    <div class="bg-gray-900 border border-gray-700 rounded-xl p-4 text-center">
                        ...
                        <div class="text-2xl font-bold text-green-400 mb-1" id="week-total-value">$1.00</div>
                    ...
                    <div class="bg-gray-900 border border-gray-700 rounded-xl p-4 text-center">
                        ...
                        <div class="text-2xl font-bold text-purple-400 mb-1" id="week-avg-value">$1.00</div>
                    ...
                    <div class="bg-gray-900 border border-gray-700 rounded-xl p-4 text-center">
                        ...
                        <div class="text-lg font-bold text-orange-400 mb-1" id="week-period">August 1 - August 7</div>
            ...
            weekTabsContainer.innerHTML = weeks.map((week, index) => `
                <div class="relative week-tab-container">
                    <button class="week-tab px-3 py-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-white transition text-sm font-semibold" 
                            data-week-id="${week.id}" title="${week.displayRange || week.startDate + ' - ' + week.endDate}">
                        ${week.name}
                    </button>
                </div>
            `).join('')
    ...
    createWeeklyDistributionChart() {
        ...
        if (!canvas) {
            console.warn('Weekly distribution chart canvas not found')
            return
        }
