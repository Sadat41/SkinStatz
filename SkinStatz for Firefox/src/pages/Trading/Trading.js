...
export class TradingPage {
                            ...
                            <section class="bg-gray-900 border border-gray-700 rounded-2xl p-10 mb-8 shadow-2xl backdrop-blur-sm">
                                ...
                                <form id="tradeForm" class="space-y-8">
                                        ...
                                        <div class="group">
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <button type="button" id="buy-date-picker-btn"
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <input type="date" id="sellDatePicker"
                                                            class="absolute opacity-0 pointer-events-none" tabindex="-1">
                                                    <button type="button" id="sell-date-picker-btn"
                                                            class="relative z-10 p-2 text-gray-400 hover:text-white transition-colors duration-200" title="Open calendar">
                                                        <i data-lucide="calendar" class="w-5 h-5"></i>
                                                    </button>
                                                </div>
                                    ...
                                    <div class="flex justify-center">
                                        <button type="button" id="safe-add-trade-btn" class="group relative bg-gray-900 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-600 text-gray-300 hover:text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center gap-2 overflow-hidden border border-gray-700 hover:border-transparent">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex items-center gap-1 bg-gray-800 p-1 rounded-lg border border-gray-600">
                                                <button data-status-filter="null" 
                                                        id="statusFilterAll"
                                                ...
                                                <button data-status-filter="holding" 
                                                        id="statusFilterHolding"
                                                        class="status-filter-btn px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200 text-gray-400 hover:text-white hover:bg-gray-700">
                                                    Holding
                                                </button>
                                                <button data-status-filter="sold" 
                                                        id="statusFilterSold"
                                                        class="status-filter-btn px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200 text-gray-400 hover:text-white hover:bg-gray-700">
                                                    Sold
                                                </button>
                                            ...
                                            <div class="relative z-[9999]">
                                                ...
                                                <div id="sortDropdown" class="absolute top-full right-0 mt-2 bg-gray-900 border-2 border-gray-600 rounded-lg shadow-2xl" style="display: none; min-width: 160px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.8); z-index: 10000;">
                                                    <div class="p-2">
                                                        <button data-sort-option="recent" 
                                                        ...
                                                        <button data-sort-option="ascending" 
                                                                class="sort-option w-full text-left px-3 py-2 text-xs text-gray-300 hover:text-white hover:bg-gray-700 rounded-md transition-all duration-200 flex items-center gap-2">
                                                            <i data-lucide="trending-up" class="w-3.5 h-3.5"></i>
                                                            Ascending (Low to High)
                                                        </button>
                                                        <button data-sort-option="descending" 
                                                                class="sort-option w-full text-left px-3 py-2 text-xs text-gray-300 hover:text-white hover:bg-gray-700 rounded-md transition-all duration-200 flex items-center gap-2">
                            ...
                            <form id="edit-trade-form" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="flex items-center gap-2 relative z-10">
                                            ...
                                            <button type="button" id="edit-buy-date-picker-btn" class="p-1 text-gray-400 hover:text-white transition-colors duration-200" title="Open calendar">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button type="button" id="edit-sell-date-picker-btn" class="p-1 text-gray-400 hover:text-white transition-colors duration-200" title="Open calendar">
                                            <i data-lucide="calendar" class="w-4 h-4"></i>
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="flex items-center gap-2 relative z-10">
                                                ...
                                                <input type="date" id="editTradeBuyDatePicker"
                                                       class="absolute opacity-0 pointer-events-none" tabindex="-1">
                                                <button type="button" id="edit-trade-buy-date-picker-btn"
                                        ...
                                        <div class="relative">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <input type="date" id="editTradeSellDatePicker"
                                                       class="absolute opacity-0 pointer-events-none" tabindex="-1">
                                                <button type="button" id="edit-trade-sell-date-picker-btn"
                ...
                <div class="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 scale-95">
                    ...
                    <div class="p-6">
                        <form id="addTradeForm">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="flex items-center gap-2 relative z-10">
                                                ...
                                                <input type="date" id="addTradeBuyDatePicker" value="${this.getTodayISO()}"
                                                       class="absolute opacity-0 pointer-events-none" tabindex="-1">
                                                <button type="button" id="add-trade-buy-date-picker-btn"
                                                        class="p-2 text-gray-400 hover:text-white transition-colors duration-200" title="Open calendar">
                                                    <i data-lucide="calendar" class="w-4 h-4"></i>
                                                </button>
                                            </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="flex items-center gap-2 relative z-10">
                                                ...
                                                <input type="date" id="addTradeSellDatePicker"
                                                       class="absolute opacity-0 pointer-events-none" tabindex="-1">
                                                <button type="button" id="add-trade-sell-date-picker-btn"
                                                        class="p-2 text-gray-400 hover:text-white transition-colors duration-200" title="Open calendar">
                                                    <i data-lucide="calendar" class="w-4 h-4"></i>
                                                </button>
                                            </div>
                            ...
                            <!-- Action Buttons -->
                            <div class="flex gap-4 mt-8 pt-6 border-t border-gray-700">
                                <button type="button" id="close-add-trade-modal-btn" 
                                        class="flex-1 bg-gray-700 hover:bg-gray-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-105 flex items-center justify-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                    </svg>
                    ...
                    <div class="flex items-center gap-3 w-full">
                        ...
                        <div class="flex-none w-28 flex items-center justify-center">
                            <div class="flex gap-1 items-center">
                                ${status === 'holding' ? `
                                    <button data-action="sell" data-trade-index="${originalIndex}" class="text-green-400 hover:text-green-300 transition p-1 rounded hover:bg-green-900/20" title="Sell Trade">
                                        <i data-lucide="trending-up" class="w-4 h-4"></i>
                                    </button>
                                ` : `
                                    <div class="w-6"></div>
                                `}
                                <button data-action="edit" data-trade-index="${originalIndex}" class="text-blue-400 hover:text-blue-300 transition p-1 rounded hover:bg-blue-900/20" title="Edit Trade">
                                    <i data-lucide="edit" class="w-4 h-4"></i>
                                </button>
                                <button data-action="delete" data-trade-index="${originalIndex}" class="text-red-400 hover:text-red-300 transition p-1 rounded hover:bg-red-900/20" title="Delete Trade">
    ...
    getTradingData() {
        ...
        if (savedTrades) {
            ...
            console.log('🆕 No saved trades found, starting with empty state')
            trades = []
        }
    ...
    /**
     * Setup event listeners for CSP-compliant buttons
     */
    setupCSPCompliantEventListeners() {
        // Date picker buttons
        const buyDatePickerBtn = document.getElementById('buy-date-picker-btn')
        if (buyDatePickerBtn) {
            buyDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('buyDatePicker').showPicker()
            })
        }

        const sellDatePickerBtn = document.getElementById('sell-date-picker-btn')
        if (sellDatePickerBtn) {
            sellDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('sellDatePicker').showPicker()
            })
        }

        const editBuyDatePickerBtn = document.getElementById('edit-buy-date-picker-btn')
        if (editBuyDatePickerBtn) {
            editBuyDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('edit-buy-date-picker').showPicker()
            })
        }

        const editSellDatePickerBtn = document.getElementById('edit-sell-date-picker-btn')
        if (editSellDatePickerBtn) {
            editSellDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('edit-sell-date-picker').showPicker()
            })
        }

        const editTradeBuyDatePickerBtn = document.getElementById('edit-trade-buy-date-picker-btn')
        if (editTradeBuyDatePickerBtn) {
            editTradeBuyDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('editTradeBuyDatePicker').showPicker()
            })
        }

        const editTradeSellDatePickerBtn = document.getElementById('edit-trade-sell-date-picker-btn')
        if (editTradeSellDatePickerBtn) {
            editTradeSellDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('editTradeSellDatePicker').showPicker()
            })
        }

        const addTradeBuyDatePickerBtn = document.getElementById('add-trade-buy-date-picker-btn')
        if (addTradeBuyDatePickerBtn) {
            addTradeBuyDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('addTradeBuyDatePicker').showPicker()
            })
        }

        const addTradeSellDatePickerBtn = document.getElementById('add-trade-sell-date-picker-btn')
        if (addTradeSellDatePickerBtn) {
            addTradeSellDatePickerBtn.addEventListener('click', (e) => {
                e.preventDefault()
                document.getElementById('addTradeSellDatePicker').showPicker()
            })
        }

        // Main action buttons
        const safeAddTradeBtn = document.getElementById('safe-add-trade-btn')
        if (safeAddTradeBtn) {
            safeAddTradeBtn.addEventListener('click', (e) => {
                e.preventDefault()
                window.tradingPage?.safeAddTrade()
            })
        }

        const closeAddTradeModalBtn = document.getElementById('close-add-trade-modal-btn')
        if (closeAddTradeModalBtn) {
            closeAddTradeModalBtn.addEventListener('click', (e) => {
                e.preventDefault()
        ...
        document.querySelectorAll('[data-status-filter]').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                window.tradingPage?.selectStatusFilter(filter === 'null' ? null : filter)
            })
        })
        ...
        document.querySelectorAll('[data-sort-option]').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                window.tradingPage?.selectSortOption(option)
            })
        })
        ...
        if (errorReloadBtn) {
            errorReloadBtn.addEventListener('click', (e) => {
                e.preventDefault()
                location.reload()
            })
        }

        // Trade action buttons (dynamically generated)
        document.addEventListener('click', (e) => {
            if (e.target.closest('[data-action]')) {
                e.preventDefault()
                const button = e.target.closest('[data-action]')
                const action = button.getAttribute('data-action')
                const tradeIndex = button.getAttribute('data-trade-index')
                
                switch (action) {
                    case 'sell':
                        window.tradingPage?.openSellModal(parseInt(tradeIndex))
                        break
                    case 'edit':
                        window.tradingPage?.editTrade(parseInt(tradeIndex))
                        break
                    case 'delete':
                        window.tradingPage?.deleteTrade(parseInt(tradeIndex))
                        break
                }
            }
        })
